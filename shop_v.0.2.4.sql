...
drop table menu_has_option_group;
...
rename table `menus_has_option_groups` TO `menu_has_option_group`;
...
alter table `holiday` add `holiday_end_date` date not null after `holiday_date`;
