...
drop table menus_has_option_groups;
...
drop table stores_has_catergories;
...
CREATE TABLE IF NOT EXISTS  `stores` (
                                                     ...
                                                     `default_earning_rate` DECIMAL(1,0) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS  `coupon_usage_store` (
                                                                 `coupon_usage_id` BIGINT NOT NULL,
                                                                 `stores_store_id` BIGINT NOT NULL,
                                                                 PRIMARY KEY (`coupon_usage_id`),
                                                                 INDEX `fk_coupon_usage_store_stores1_idx` (`stores_store_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS  `deliveries` (
                                                         `delivery_code` CHAR(36) NOT NULL,
                                                         `order_code` CHAR(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS  `stores_has_catergories` (
                                                                     `store_id` BIGINT NOT NULL,
                                                                     `category_code` VARCHAR(10) NOT NULL,
                                                                     PRIMARY KEY (`store_id`, `category_code`),
                                                                     INDEX `FK_store_categories_TO_stores_has_catergories_1` (`category_code` ASC) VISIBLE,
